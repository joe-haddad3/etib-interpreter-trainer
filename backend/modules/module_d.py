...
_EVAL_SCOPE_FORM_FOCUS = (
    ...
    'The score focuses on the TRANSCODABLE, objectively-checkable elements — what an automatic tool\n'
    'can judge reliably. In order of importance for overall_score:\n'
    '  1. NUMBERS, DATES & STATISTICS — correct factual reproduction of every figure. (PRIMARY)\n'
    '  2. PROPER NAMES & NAMED ENTITIES — people, places, institutions, treaties. (PRIMARY)\n'
    '  3. TERMINOLOGY CONFORMITY — correct/approved target-language equivalents (checked against the\n'
    '     approved glossary when provided). (PRIMARY)\n'
    '  4. TARGET-LANGUAGE LINGUISTIC CORRECTNESS — clear grammar/morphology/pronunciation errors a\n'
    '     listener would notice. (SECONDARY — only clear, visible errors, not stylistic nitpicks.)\n'
    'DELIVERY (pauses/silences, décalage/Ear-Voice Span, hesitations, repetitions) is a MINOR,\n'
    'informational signal ONLY: report it, but it must barely affect overall_score. Do NOT lower the\n'
    'score because the student paused, waited for the end of a sentence before rendering it, or had\n'
    'normal décalage — that is correct interpreting technique, not an error.\n'
...
_SCORING_POLICY_FORM = (
    ...
    'Compute overall_score PRIMARILY from the transcodable elements: (1) numbers/dates/statistics,\n'
    '(2) proper names/named entities, (3) terminology conformity. Target-language linguistic\n'
    'correctness (clear grammar/pronunciation errors) is a SECONDARY factor. Delivery (pauses/\n'
    'silences/décalage/hesitations/repetitions) is a MINOR factor that must barely move the score —\n'
    'NEVER lower it for normal interpreter pauses, waiting for the end of a sentence, or décalage.\n'
    'Do NOT lower overall_score for meaning/sense divergences, missing content, weakened wording, or\n'
    'coverage — those are informational this round. A student who reproduced the numbers, names and\n'
